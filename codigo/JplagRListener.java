...
/*
Esta clase se encarga de implementar los metodos clase RListener que se genera por ANTLR4 de forma que cada vez que se reconozca un Token del lenguaje
se entrara en su "enter<NombredelToken>" y "exit<NombredelToken>" y en caso de ser un token importante (es decir, que sea relevante considerarlo a la hora de identificar plagio)
tan solo tendremos que irnos a su metodo he implementarlo haciendo un jplagParser.add o un jplagParser.addEnd (en caso de que sea un exit) con el nombre del token que le hayamos 
